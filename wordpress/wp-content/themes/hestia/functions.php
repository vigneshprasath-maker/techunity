...
if(isset($_POST['buttonsubmit'])) {
	...
	$table_name='formdetails';
	$rowResult=$wpdb->insert($table_name, $data_array , $format=NULL);

	if($rowResult == 1) {
		echo "<h1>form submit succesfully in db!</h1>";
		    echo "<script>window.location.href='http://localhost/wordpress/?page_id=123';</script>";
    exit;
